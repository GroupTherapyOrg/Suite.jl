    ...
    Main.Sheet(
        ...
        Main.SheetContent(side="left",
            ...
            Nav(:class => "flex flex-col gap-2 mt-4",
                ...
                Div(:class => "mt-2",
                    Span(:class => "text-xs font-semibold text-warm-500 dark:text-warm-500 uppercase tracking-wider", "Widgets"),
                ),
                _MobileLink("Overview", "./widgets/"),
                _MobileLink("The @bind Pattern", "./widgets/bind/"),
                _MobileLink("Slider", "./widgets/slider/"),
                Div(:class => "mt-2",
...
function Layout(children...; title="Suite.jl")
    Div(:class => "min-h-screen flex flex-col bg-warm-50 dark:bg-warm-950 transition-colors duration-200",
        # Theme init: restore saved theme from localStorage, default to Islands, handle theme option clicks
