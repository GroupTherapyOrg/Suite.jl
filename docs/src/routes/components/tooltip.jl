...
function TooltipPage()
    ComponentsLayout(
        # Header
        PageHeader("Tooltip", "A popup that displays information related to an element when the element receives keyboard focus or the mouse hovers over it."),
