...
function EmptyPage()
    ComponentsLayout(
        Div(:class => "py-8 border-b border-warm-200 dark:border-warm-700 mb-10",
            H1(:class => "text-4xl font-serif font-semibold text-warm-800 dark:text-warm-50 mb-3", "Empty"),
...
Empty(
    ...
    EmptyAction(Button("Try Again"))
        ...
        Div(:class => "mt-12 space-y-6",
            ...
            H3(:class => "text-lg font-semibold text-warm-800 dark:text-warm-50 mt-6 mb-3", "Empty"),
