...
function StatusBarPage()
    ComponentsLayout(
        Div(:class => "py-8 border-b border-warm-200 dark:border-warm-700 mb-10",
            H1(:class => "text-4xl font-serif font-semibold text-warm-800 dark:text-warm-50 mb-3", "Status Bar"),
...
StatusBar(
    ...
    StatusBarSection(position="right",
        ...
        Div(:class => "mt-12 space-y-6",
            ...
            H3(:class => "text-lg font-semibold text-warm-800 dark:text-warm-50 mt-6 mb-3", "StatusBar"),
            ...
            H3(:class => "text-lg font-semibold text-warm-800 dark:text-warm-50 mt-6 mb-3", "StatusBarSection"),
            Div(:class => "overflow-x-auto",
                Table(:class => "w-full text-sm",
                    Thead(Tr(:class => "border-b border-warm-200 dark:border-warm-700",
                        Th(:class => "py-3 px-4 text-left text-warm-800 dark:text-warm-300 font-semibold", "Prop"),
            ...
            H3(:class => "text-lg font-semibold text-warm-800 dark:text-warm-50 mt-6 mb-3", "StatusBarItem"),
            Div(:class => "overflow-x-auto",
                Table(:class => "w-full text-sm",
                    Thead(Tr(:class => "border-b border-warm-200 dark:border-warm-700",
                        Th(:class => "py-3 px-4 text-left text-warm-800 dark:text-warm-300 font-semibold", "Prop"),
