...
function Card(children...; class::String="", theme::Symbol=:default, kwargs...)
    classes = cn("glass-panel rounded-xl border border-warm-200 dark:border-warm-700 bg-warm-100 dark:bg-warm-900 text-warm-800 dark:text-warm-300 shadow-sm flex flex-col gap-6 p-8 text-sm", class)
...
function CardHeader(children...; class::String="", kwargs...)
    classes = cn("flex flex-col gap-1.5", class)
    Div(:class => classes, kwargs..., children...)
end
...
function CardFooter(children...; class::String="", kwargs...)
    classes = cn("flex items-center", class)
    Div(:class => classes, kwargs..., children...)
end
