# Textarea.jl — Suite.jl Textarea Component
#
# Tier: styling (pure HTML + Tailwind classes, no JS/Wasm)
# Suite Dependencies: none (leaf component)
# JS Modules: none
#
# Usage via package: using Suite; Textarea(placeholder="Enter text...")
# Usage via extract: include("components/Textarea.jl"); Textarea(...)
#
...
```
"""
function Textarea(; class::String="", theme::Symbol=:default, kwargs...)
    classes = cn(
    ...
    Therapy.Textarea(:class => classes, kwargs...)
end
