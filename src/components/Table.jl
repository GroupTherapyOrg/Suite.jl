# SuiteTable.jl — Suite.jl Table Component
#
# Tier: styling (pure HTML + Tailwind classes, no JS/Wasm)
# Suite Dependencies: none (leaf component)
# JS Modules: none
#
# Usage via package: using Suite; SuiteTable(SuiteTableHeader(...), SuiteTableBody(...))
# Usage via extract: include("components/Table.jl"); SuiteTable(...)
#
...
export SuiteTable, SuiteTableHeader, SuiteTableBody, SuiteTableFooter,
       SuiteTableRow, SuiteTableHead, SuiteTableCell, SuiteTableCaption

"""
    SuiteTable(children...; class, kwargs...) -> VNode
...
```
"""
function SuiteTable(children...; class::String="", kwargs...)
    table_classes = cn("w-full caption-bottom text-sm", class)

    Div(:class => "relative w-full overflow-x-auto",
        Table(:class => table_classes, kwargs..., children...),
    )
end

"""
    SuiteTableHeader(children...; class, kwargs...) -> VNode
...
"""
    SuiteTableBody(children...; class, kwargs...) -> VNode

Table body section (`<tbody>`).
"""
function SuiteTableBody(children...; class::String="", kwargs...)
    classes = cn("", class)
    Tbody(:class => classes, kwargs..., children...)
end

"""
    SuiteTableFooter(children...; class, kwargs...) -> VNode
...
"""
    SuiteTableRow(children...; class, kwargs...) -> VNode
...
"""
    SuiteTableHead(children...; class, kwargs...) -> VNode
...
"""
    SuiteTableCell(children...; class, kwargs...) -> VNode

A table data cell (`<td>`).
"""
function SuiteTableCell(children...; class::String="", kwargs...)
    classes = cn("p-2 align-middle whitespace-nowrap", class)
    Td(:class => classes, kwargs..., children...)
end

"""
    SuiteTableCaption(children...; class, kwargs...) -> VNode
...
if @isdefined(register_component!)
    register_component!(ComponentMeta(
        ...
        Symbol[],
        Symbol[],
        [:SuiteTable, :SuiteTableHeader, :SuiteTableBody, :SuiteTableFooter,
         :SuiteTableRow, :SuiteTableHead, :SuiteTableCell, :SuiteTableCaption],
    ))
end
