...
;(function() {
    ...
    const Suite = {
        ...
        // --- SyntaxHighlight: removed (inlined into Therapy.jl modal_state mode=18 — SUITE-916) ---

        // --- CodeBlock: removed (now @island with BindModal mode=18 — SUITE-916) ---

        // --- TreeView: removed (now @island with BindModal mode=19 — SUITE-916) ---
